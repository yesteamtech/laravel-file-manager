...
<head>
  ...
  <link rel="stylesheet" href="<?= url('vendor-public/laravel-filemanager/css/cropper.min.css') ?>">
...
<body>
                  ...
                  <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse">
                      <ul class="nav navbar-nav" id="nav-buttons">
                        ...
                        <li class="yes-up-folder-btn-container"><a style='cursor:default;'>|</a></li>
                        <li>
  ...
  <script src="<?= url('vendor-public/laravel-filemanager/js/cropper.min.js')  ?>"></script>
  <script src="<?= url('vendor-public/laravel-filemanager/js/jquery.form.min.js')  ?>"></script>
