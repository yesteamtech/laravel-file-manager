<?php namespace Yesteamtech\Laravelfilemanager;
 ...
 * @package Yesteamtech\Laravelfilemanager
 */
class LaravelFilemanagerServiceProvider extends ServiceProvider {
    ...
    public function boot()
    {
        ...
        $this->publishes([      
            __DIR__.'/../public' => public_path('vendor-public/laravel-filemanager'),     
        ], 'lfm_public');
    ...
    public function register()
    {
        $this->app->singleton('laravel-filemanager', function ($app) {
               return new \Yesteamtech\Laravelfilemanager();
        });
    }
}
